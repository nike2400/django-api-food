...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_full_update(self):
        ...
        payload = {
            ...
            'description': 'New recipe desctiption',
            'time_minutes': 10,
            'price': Decimal('2.50')
        }
    ...
    def test_detele_other_users_recipe_error(self):
    ...
    def test_create_recipe_with_existing_tags(self):
        ...
        payload = {
            ...
            'time_minutes': 60,
            'price': Decimal('4.50'),
            'tags': [{'name': 'Indian'}, {'name': 'Breakfas'}]
        }
    ...
    def test_filtering_by_tags(self):
        r1 = create_recipe(user=self.user, title='Thai Vegetable Currry')
